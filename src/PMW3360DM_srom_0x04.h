#ifndef _PMW3360DM_srom_0x04_H_
#define _PMW3360DM_srom_0x04_H_
...
// the firmeware that is uploaded in the PMW3360DM_T2QU each time it boots

#define srom_version 0x04
